...
<html>
<head>
    <title>FlTable Basic Demo</title>
    <link rel="stylesheet" href="../dist/fl-table.css">
    <style>
...
<body>
    ...
    <script>
        ...
        Handlebars.registerPartial('file-cell', `
        ...
        table.on('selection:change', (event) => {
            const { selected, source } = event.detail;
...
<body>
    <div class="demo-container">
        <div class="demo-header">
            <h1>FlTable Advanced Features</h1>
            <div class="demo-controls">
                <button onclick="loadData()">Refresh Data</button>
                <button onclick="table.selectAll()">Select All</button>
                <button onclick="table.deselectAll()">Deselect All</button>
            </div>
        </div>
...
### Test Setup (test/index.html)

```html
<!DOCTYPE html>
<html>
<head>
    <title>FlTable Tests</title>
...
<body>
    ...
    <script src="specs/fl-table.spec.js"></script>
...
### Test Specification (test/specs/fl-table.spec.js)
...
describe('FlTable', () => {
    ...
    it('should initialize with basic configuration', () => {
        ...
        chai.expect(container.querySelector('.fl-table')).to.exist;
        chai.expect(container.querySelector('.fl-table-row')).to.exist;
    });
    ...
    it('should handle selection', () => {
        ...
        const firstRow = container.querySelector('.fl-table-row');
        const checkbox = firstRow.querySelector('input[type="checkbox"]');

        checkbox.click();

        chai.expect(table.getSelectedRows()).to.have.lengthOf(1);
        chai.expect(firstRow.classList.contains('fl-table-selected')).to.be.true;
    });
